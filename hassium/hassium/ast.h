...
struct ast_node *bin_op_node_new(bin_op_type_t, struct ast_node *, struct ast_node *);
struct ast_node *class_decl_node_new(char *, struct ast_node *, struct ast_node *);
struct ast_node *code_block_node_new(struct vec *);
struct ast_node *expr_stmt_node_new(struct ast_node *);
struct ast_node *for_node_new(struct ast_node *, struct ast_node *, struct ast_node *, struct ast_node *);
struct ast_node *foreach_node_new(char *, struct ast_node *, struct ast_node *);
struct ast_node *func_decl_node_new(char *, struct vec *, struct ast_node *, struct ast_node *);
struct ast_node *id_node_new(char *);
struct ast_node *if_node_new(struct ast_node *, struct ast_node *, struct ast_node *);
...
struct ast_node *try_catch_node_new(struct ast_node *, struct ast_node *, char *);
